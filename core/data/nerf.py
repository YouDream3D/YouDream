...
class NeRFDataset:
    ...
    def collate(self, index):
        ...
        if self.training:
            ...
            poses, dirs, phi = rand_pose(B, self.device, radius_range=self.radius_range, theta_range=self.cfg.theta_range, phi_range=self.cfg.phi_range,
            ...
            cond_images = self.image_prompt(intrinsics, poses, dirs)
        else:
            ...
            poses, dirs = circle_pose(self.device, radius=radius, theta=theta, phi=phi, return_dirs=True, view_prompt=self.view_prompt)
